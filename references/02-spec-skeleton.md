...
### §1 — Decisiones estratégicas · `[FRAMING]`
...
### §2 — Enfoque de arquitectura · `[FRAMING]`
...
### §3 — Arquitectura de URLs y content-types · `[ENSAMBLAJE · CONSUME arquitectura.csv]`
...
### §4 — Clusters e internal linking · `[ENSAMBLAJE · CONSUME enlazado.csv]`
...
### §5 — Schemas y datos estructurados · `[ENSAMBLAJE · anclaje; genera schema-graph]`
En master: 5.1 estrategia de grafo JSON-LD con `@id` (anclaje conceptual) · 5.2 tabla schema/dónde/propósito a alto nivel. La **generación del grafo** (esqueleto del grafo en Home) y la **validación pre-deploy** son entregables de la skill `schema-graph`, no de master. Ver `04-schema.md`.

### §6 — Local SEO y GBP · `[ENSAMBLAJE]`
...
### §7 — GEO, AI Overviews, llms.txt y E-E-A-T · `[ENSAMBLAJE]`
...
### §8 — Technical SEO foundation · `[ENSAMBLAJE]`
...
### §9 — Keyword research y mapa por cluster · `[ENSAMBLAJE · CONSUME mapa-keywords.csv]`
...
### §10 — Plan de contenido 12 meses · `[ENSAMBLAJE]`
...
### §11 — Análisis competitivo y link building · `[ENSAMBLAJE]`
...
### §12 — KPIs, dashboard y tooling · `[ENSAMBLAJE]`
Jerarquía 3 tiers · proyección Q1-Q4 · tooling · reporting · atribución · alertas. Ver `10-kpis.md`.

### §13 — Roadmap consolidado, riesgos y supuestos · `[ENSAMBLAJE]`
...
### §14 — Briefs de página (con copy) · `[ENSAMBLAJE]`
